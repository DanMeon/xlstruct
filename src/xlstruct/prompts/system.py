...
- If the spreadsheet contains formula annotations (e.g., "=SUM(...)"), use the cached/computed \
value, not the formula string itself, unless the schema specifically asks for formulas.
